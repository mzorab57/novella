              ...
              <Reveal delay={0.4}>
                <div className="grid grid-cols-3 gap-6 border-t border-primary/10 pt-8">
                  <div>
                    ...
                    <p className="font-inter text-[9px] uppercase tracking-[0.3em] text-neutral-500 mt-1">Peak Power</p>
                  </div>
                  <div>
                    ...
                    <p className="font-inter text-[9px] uppercase tracking-[0.3em] text-neutral-500 mt-1">Precision</p>
                  </div>
                  <div>
                    ...
                    <p className="font-inter  text-[9px] uppercase tracking-[0.3em] text-neutral-500 mt-1">Efficiency</p>
                  </div>
                </div>
              </Reveal>
            </div>
